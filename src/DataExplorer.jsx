...
/* ===== Independent Market Comparison Block ===== */
function ComparisonBlock({ raw, baseCountry, baseCity, baseSubmarket }) {
  ...
  const submarkets2 =
    raw.countries?.[country2]?.cities?.[city2]?.periods?.[
      Object.keys(raw.countries[country2]?.cities?.[city2]?.periods || {})[0]
    ]?.subMarkets
      ? Object.keys(
          raw.countries[country2].cities[city2].periods[
            Object.keys(raw.countries[country2].cities[city2].periods)[0]
...
export default function DataExplorer() {
  ...
  return (
    <div style={{ fontFamily: "Arial, sans-serif", padding: "20px" }}>
      ...
      {/* === first three blocks exactly as before === */}
      <div>
        <select
          value={country}
          onChange={(e) => {
        ...
        <>
          ...
          <div className="section-box">
            ...
            <Row
              label="Fit-out (€/sqm)"
              value={fmtNumber(
                coerceNumber(leasingSource?.fitOutEurSqmShellCore ?? null)
              )}
            />
            <Row
              label="Service charge (€/sqm/month)"
              value={fmtMoney(
                coerceNumber(leasingSource?.serviceChargeEurSqmMonth ?? null)
              )}
            />
          </div>
